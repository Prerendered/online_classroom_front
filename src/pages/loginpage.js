...
export default function SignInSide() {
  ...
  const handleClose = () => {
    // Added this function to close the dialog
    setOpen(false);
  };
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid
          ...
          sx={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1599081593734-5e65dd7abfba?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80)",
